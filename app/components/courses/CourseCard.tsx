...
import { ICourse } from "@/app/models/Course"; // ✅ import direct du type

// Utilisation directe du type ICourse (avec _id: string obligatoire)
...
export default function CourseCard({ course }: CourseCardProps) {
  ...
  return (
    <Link href={`/cours/${course.slug}`}>
      <Card hover>
        {/* ✅ bg-linear-to-br pour Tailwind v4 */}
        <div className="h-48 bg-linear-to-br from-primary-400 to-primary-600 flex items-center justify-center text-6xl">
