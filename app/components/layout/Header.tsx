...
export default function Header() {
  ...
  // pour éviter les incohérences d'hydratation avec le compteur du panier.
  useEffect(() => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-Lime-800 text-black shadow-md border-b border-Rose-600">
