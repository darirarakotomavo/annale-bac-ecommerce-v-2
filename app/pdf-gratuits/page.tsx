...
const pdfList = [
    // === MATHÉMATIQUES ===
    {
        ...
        description: 'Sujet officiel de l\'épreuve de Mathématiques (3 exercices + 2 problèmes).',
    ...
    // === PHYSIQUE ===
    {
        ...
        description: 'Sujet officiel de l\'épreuve de Sciences Physiques (5 exercices).',
    ...
    },
    {
        ...
        description: 'Corrigé complet de l\'épreuve de Sciences Physiques (9 pages).',
            ...
            <main className="min-h-screen py-16 bg-gray-50">
                <div className="container-custom max-w-5xl">
                    ...
                    <p className="text-center text-gray-500 mb-4 max-w-2xl mx-auto">
                        Téléchargez gratuitement les sujets et corrigés des épreuves du Bac Madagascar 2025 – Série S.
                    </p>
                        ...
                        {pdfList.map((pdf) => (
                            <Card key={pdf.id} hover>
                                <CardBody className="flex flex-col items-start gap-3">
                                    ...
                                    <p className="text-sm text-gray-500 flex-1">{pdf.description}</p>
                    ...
                    <div className="mt-12 bg-emerald-50 border border-emerald-200 rounded-xl p-6 text-center">
                        <p className="text-sm text-gray-700">
                            📚 Ces documents sont offerts gratuitement pour vous aider à préparer le Bac.
                            N&apos;hésitez pas à les partager avec vos camarades !
                        </p>
                    </div>
                </div>
            </main>
