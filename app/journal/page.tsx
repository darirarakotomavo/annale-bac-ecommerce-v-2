            ...
            <main className="min-h-screen py-16 bg-gray-50">
                <div className="container-custom max-w-4xl">
                    <div className="text-center mb-12">
                        <h1 className="text-4xl font-bold text-gray-900 mb-4">📖 Journal des Révisions</h1>
                        <p className="text-gray-500 max-w-2xl mx-auto">
                            Des conseils, des astuces et des réflexions pour vous accompagner dans votre préparation au Bac 2026.
                        </p>
                    ...
                    <div className="mt-12 bg-primary-50 border border-primary-200 rounded-xl p-6 text-center">
                        <h3 className="font-bold text-gray-800 mb-2">💬 Rejoignez la communauté</h3>
                        <p className="text-sm text-gray-600">
                            Partagez vos questions et vos progrès sur mes réseaux sociaux.
                        </p>
                        <div className="flex justify-center gap-4 mt-3">
                            <a href="https://www.facebook.com/votre-profil" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:text-primary-700">📘 Facebook</a>
                            <a href="https://www.instagram.com/votre-profil" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:text-primary-700">📸 Instagram</a>
                            <a href="https://wa.me/261322462274" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:text-primary-700">💬 WhatsApp</a>
                        </div>
                    </div>
                </div>
            </main>
